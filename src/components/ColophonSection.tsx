...
const STACK = ["next@16.3.4", "react@19.2.8", "tailwindcss@4"];
const LIBRARIES = ["motion@13.2.0", "next-themes", "lucide-react"];
  ...
  return (
    <section className="w-full">
      <div className="flex items-baseline justify-between gap-4 text-[14px] leading-[20px]">
        <span className="font-mono font-medium text-foreground">{content.name}</span>
      ...
      <div className="mt-[14px] grid grid-cols-2 overflow-hidden rounded-lg border-t border-l border-dashed border-neutral-200 lg:grid-cols-4 dark:border-neutral-800">
        <div className={CELL}>
          ...
          <Value href="https://www.facebook.com/tamal.ehmad15/">@tamal.ehmad15</Value>
        </div>
        <div className={CELL}>
          <Term>Build</Term>
          <Value>{BUILD}</Value>
        ...
        <div className={CELL}>
          ...
          <Value href="https://github.com/fiftee15n">GitHub</Value>
        </div>
        <div className={CELL}>
          <Term>Domain</Term>
          <Value>tamal.dev</Value>
        </div>
        <div className={CELL}>
          <Term>Typeface</Term>
          <Value>Geist</Value>
